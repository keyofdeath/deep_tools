...
class NeuralNetwork:
    def __init__(self, layers, alpha=0.1):
        ...
        :param layers: A list of integers which represents the actual architecture of the feedforward network.
        ...
        :param alpha: Here we can specify the learning rate of our neural network.
